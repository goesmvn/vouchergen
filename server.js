...
async function initializeDatabase() {
  try {
    ...
    // Safe migration: Add discount_type to agents table if it doesn't exist
    try {
      await dbRun("ALTER TABLE agents ADD COLUMN discount_type TEXT DEFAULT 'percentage'");
      console.log("Added discount_type column to agents.");
    } catch (e) {
      // ignore
    }
    ...
    const defaultSettings = [
      ...
      { key: 'chatbot_knowledge', value: 'Batur Natural Hot Spring (sering disebut juga Batur Hot Spring & GreenLeaf Park) adalah destinasi wisata pemandian air panas alami yang terletak di Toya Bungkah, Kintamani, Bangli, Bali, Indonesia.\n\nTempat ini buka setiap hari dari jam 07:00 WITA sampai jam 19:00 WITA. Pengunjung dapat menikmati pemandian air panas alami yang menyuguhkan pemandangan langsung ke Danau Batur dan Gunung Batur yang megah.\n\nFasilitas yang tersedia di Batur Natural Hot Spring meliputi kolam air panas alami untuk dewasa dan anak-anak, ruang ganti pakaian yang bersih, toilet, shower untuk bilas, kursi berjemur di tepi kolam, serta penyewaan loker dan handuk.\n\nDi area pemandian juga terdapat Lakeview Restaurant yang menyajikan berbagai makanan khas Bali, hidangan nusantara, dan makanan barat (Western food) dengan pemandangan danau yang indah. Selain itu, tersedia juga layanan pijat tradisional dan spa bagi pengunjung yang ingin relaksasi lebih dalam.\n\nManfaat berendam di kolam air panas alami Batur Hot Spring sangat banyak karena airnya kaya akan mineral belerang (sulfur) alami. Air panas ini berkhasiat untuk terapi kesehatan kulit, meredakan nyeri otot dan sendi, memperlancar sirkulasi darah, menghilangkan stres, serta memberikan efek relaksasi pada tubuh.\n\nDaftar harga tiket masuk Batur Natural Hot Spring:\n- Tiket Masuk Dewasa (High Season): Rp 150.000 per orang.\n- Tiket Masuk Anak-anak (High Season): Rp 90.000 per anak (usia 3-10 tahun).\n- Tiket Masuk Pelajar/Mahasiswa (High Season): Rp 120.000 per orang (harus menunjukkan kartu identitas pelajar/mahasiswa aktif saat kedatangan).\nAnak di bawah usia 3 tahun tidak dikenakan biaya masuk alias gratis.\n\nKetentuan pemesanan voucher tiket masuk:\n- Pemesanan tiket masuk bisa dilakukan secara instan langsung melalui WhatsApp ini dengan mengetik kata kunci "PESAN" atau "BOOKING".\n- Voucher yang sudah dibeli tidak dapat di-refund (non-refundable), namun pengunjung dapat mengajukan jadwal ulang (reschedule) paling lambat 24 jam sebelum tanggal kunjungan awal.\n- Saat kedatangan di gerbang masuk utama (Main Gate / Gate North), pengunjung wajib menunjukkan kode QR voucher atau kode voucher (contoh: VCH-XXXXXX-XXXXXX) kepada petugas untuk dipindai dan divalidasi.\n\nMetode pembayaran yang didukung untuk pemesanan tiket otomatis lewat WhatsApp adalah:\n1. BCA Virtual Account (Transfer bank ke rekening BCA Resmi Batur Hot Spring).\n2. Mandiri Virtual Account (Transfer bank ke rekening Mandiri Resmi Batur Hot Spring).\n3. Cash / Bayar di Lokasi (menunjukkan Invoice ID pesanan WhatsApp ke loket kasir saat kedatangan).\n\nUntuk bantuan darurat atau pertanyaan langsung ke layanan pelanggan (Customer Service), pengunjung bisa menghubungi telepon resmi di +62 812-3456-7890 atau email ke info@baturhotspring.com. Informasi detail juga dapat diakses melalui website resmi kami di www.baturhotspring.com.' },
